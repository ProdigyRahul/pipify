...
exports.logOut =
  ...
  exports.isValidResetPassword =
  exports.grantValid =
  exports.forgetPassword =
  exports.reVerifyEmail =
  exports.verifyEmail =
...
const verifyEmail = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const matched = yield verification_model_1.VerificationToken.compareToken(
      userObjectId,
      token
    );
    if (!matched) {
    ...
    yield verification_model_1.VerificationToken.findOneAndDelete({
      user: userObjectId,
    });
...
const forgetPassword = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield resetPassword_model_1.PasswordResetToken.findOneAndDelete({
      user: user._id,
    });
    ...
    yield (0,
    mail_1.sendForgetPasswordLink)({ email: user.email, link: resetLink });
...
const isValidResetPassword = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const isValid =
        yield resetPassword_model_1.PasswordResetToken.compareToken(
          userId,
          token
        );
      if (!isValid) {
...
const updatePassword = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      resetPassword_model_1.PasswordResetToken.findOneAndDelete({
        user: user._id,
      });
    } catch (error) {
      res
...
const signIn = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isCorrectPassword = yield (0, bcrypt_1.compare)(
      password,
      user.password
    );
...
const updateProfile = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name } = req.body;
    const avatar =
      (_a = req.files) === null || _a === void 0 ? void 0 : _a.avatar;
    ...
    if (avatar) {
      ...
      const { secure_url, public_id } = yield cloud_1.default.uploader.upload(
        avatar.filepath,
        {
          transformation: {
            width: 300,
